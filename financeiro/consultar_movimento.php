...
if (isset($_POST['btnPesquisar'])) {
    ...
    $valor = $_POST['valor'];
    $dao = new MovimentoDAO();
    $ret = $dao->ExcluirMovimento($idMov, $idConta, $tipo, $valor);
}
?>
                ...
                <form action="consultar_movimento.php" method="post">
                    ...
                    <div class="col-md-6">
                        <div class="form-group"> <!-- DATA  -->
                            ...
                            <input type="date" class="form-control" placeholder="Coloque a data do movimento" id="data_inicial" name="data_inicial" value="<?= $dt_inicial ?>" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group"> <!-- DATA  -->
                            <label>Data final*</label>
                            <input type="date" class="form-control" placeholder="Coloque a data do movimento" id="data_final" name="data_final" value="<?= $dt_final ?>" />
                        </div>
                    </div>
                    <center>
